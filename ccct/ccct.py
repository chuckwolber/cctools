...
SCHEMA_FILE = CONFIG_DIR + "/ccct.schema.json"
...
def _load_from_config():
    ...
    Command line args always take precedence. Any args that are missing will be
    populated from a config file if one can be found.
    """
...
def _resolve_config():
    ...
    # available. Ensure requried values end up being populated.
